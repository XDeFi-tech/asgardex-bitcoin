...
var Client = /** @class */ (function () {
    ...
    function Client(_net, _electrsAPI, _phrase) {
        ...
        this.scanUTXOs = function (addressOpt) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        address = addressOpt || this.getAddress();
        ...
        this.vaultTx = function (addressVault, valueOut, memo, feeRate) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                ;
                return [2 /*return*/, broadcastTx(this.electrsAPI, txHex)]; // Broadcast TX and get txid
            });
        }); };
        // Generates a valid transaction hex to broadcast
