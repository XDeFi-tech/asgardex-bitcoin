...
var _where = "/Users/alexanderbidiuk/xdefi/asgardex-bitcoin/node_modules/tiny-secp256k1";
var author = {
	name: "Fedor Indutny",
...
function encode$1 (r, s) {
  ...
  var signature = Buffer$i.allocUnsafe(6 + lenR + lenS);
...
function encode$4 (number, buffer, offset) {
  ...
  if (!buffer) buffer = Buffer$j.allocUnsafe(encodingLength$1(number));
  if (!Buffer$j.isBuffer(buffer)) throw new TypeError('buffer must be a Buffer instance')
  if (!offset) offset = 0;
...
var toBuffer$2 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, '__esModule', { value: true });
...
unwrapExports(toBuffer$2);
var toBuffer_1 = toBuffer$2.psbtToBuffer;
var toBuffer_2 = toBuffer$2.psbtToKeyVals;
...
var Client = /** @class */ (function () {
    ...
    function Client(_net, _electrsAPI, _phrase) {
        var _this = this;
        if (_net === void 0) { _net = Network.TEST; }
        ...
        this.getExplorerUrl = function () {
            return _this.net === Network.TEST ? 'https://blockstream.info/testnet/' : 'https://blockstream.info/';
        };
